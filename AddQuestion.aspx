<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddQuestion.aspx.cs" Inherits="Practice.AddQuestion" %>
...
<body>
  ...
  <asp:TextBox runat="server" ID="txtQuestion" cssclass="form-control" placeholder="Enter Your Question"  ></asp:TextBox>
    ...
    <asp:Button runat="server" ID="btnSemester" cssclass="btn btn-outline-secondary" text="Submit" OnClick="btnSemester_Click" />
      ...
      <asp:Label runat="server" ID="lblmsg" Text=""></asp:Label>
                ...
                <asp:GridView runat="server" ID="grdview" DataSourceID="grdviewDatasource" CssClass="table table-hover list-group-item" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdview_RowCommand">
                  <Columns>
                            <asp:BoundField DataField="ID" HeaderText="Question_ID" ReadOnly="true" SortExpression="ID" />
                            <asp:BoundField DataField="Question" HeaderText="Question List" ReadOnly="true" SortExpression="Question" />
                      <asp:TemplateField>
                          <ItemTemplate>
             ...
             <asp:SqlDataSource runat="server" ID="grdviewDatasource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Dari_Questions_Profile]"></asp:SqlDataSource>
