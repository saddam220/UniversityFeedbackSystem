<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feild.aspx.cs" Inherits="Practice.Feild" %>
...
<body>
  ...
  <asp:TextBox runat="server" ID="txtFeild" cssclass="form-control" placeholder="Enter Feild Name"  ></asp:TextBox>
  <div class="input-group-append">
    <asp:Button runat="server" ID="btnFeild" cssclass="btn btn-outline-secondary" text="Submit" OnClick="btnFeild_Click" />
  </div>
</div>
      <asp:Label runat="server" ID="lblmsg" Text=""></asp:Label>
          ...
          <asp:GridView runat="server" ID="grdview" DataSourceID="grdviewDatasource" CssClass="table table-hover list-group-item" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdview_RowCommand">
                  <Columns>
                            <asp:BoundField DataField="Field_ID" HeaderText="Field ID" ReadOnly="true" SortExpression="Field_ID" />
                            <asp:BoundField DataField="Name" HeaderText="Field Name" ReadOnly="true" SortExpression="Field_Name" />
                      <asp:TemplateField>
                          <ItemTemplate>
                              <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%# Eval("Field_ID") %>'>Delete</asp:LinkButton>
                          </ItemTemplate>
                      </asp:TemplateField>
                  </Columns>
             ...
             <asp:SqlDataSource runat="server" ID="grdviewDatasource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Field_Profile]"></asp:SqlDataSource>      
