<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewQuestion.aspx.cs" Inherits="Practice.ViewQuestion" %>
  ...
  <div class="container">
     <div class="input-group" style="margin-top:20px;">
         <h2> لیست سوالات</h2>
               ...
               <asp:ListView runat="server" ID="lstView" DataSourceID="lstDataSource" DataKeyNames="ID" GroupItemCount="3">
                   ...
                   <EditItemTemplate>
                       <td runat="server" style="background-color: #999999;">ID:
                           ...
                           Question:
                           <asp:TextBox Text='<%# Bind("Question") %>' runat="server" ID="QuestionTextBox" /><br />
                   ...
                   <InsertItemTemplate>
                       <td runat="server" style="">Question:
                           <asp:TextBox Text='<%# Bind("Question") %>' runat="server" ID="QuestionTextBox" /><br />
               ...
               <asp:SqlDataSource runat="server" ID="lstDataSource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Dari_Questions_Profile]"></asp:SqlDataSource>
           </div>
