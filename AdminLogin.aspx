    ...
    <div style="margin-left:40%;  width:240px; height:235px; margin-top:30px; padding:3px; " class="container form-control border-0">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-left:60px;">
                ...
                <a  href="Members\HomePage.aspx">Back Home</a>
        ...
        <div class="row ControlPadding">
            <div class="col-md-12">
                ...
                <asp:Button ID="btn1" runat="server" Text="Admin Login" CssClass="btn btn-danger form-control" OnClick="btn1_Click"  />
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="font-size:smaller;">
             <asp:LinkButton runat="server" ID="lbtnForgot" Text="Password Forgot" CssClass="alert-info card-link"></asp:LinkButton>
            </div>
            </div>
