<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFaculty.aspx.cs" Inherits="Practice.AddFaculty" %>
...
<body>
  ...
  <div class="container">
     <div class="input-group mb-3">
         <asp:TextBox runat="server" ID="txtFaculty" CssClass="form-control" placeholder="Enter Faculty Name"></asp:TextBox>
  <div class="input-group-append">
      <asp:Button runat="server" ID="btnFaculty" CssClass="btn btn-outline-secondary" Text="Submit" OnClick="btnFaculty_Click" /> 
      ...
      <asp:Label runat="server" ID="lblmsg" Text=""></asp:Label>
              ...
              <asp:GridView runat="server" ID="grdview" DataSourceID="grdviewDatasource" CssClass="table table-hover list-group-item" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdview_RowCommand" >
                  <Columns>
                            <asp:BoundField DataField="Faculty_Code" HeaderText="Faculty ID" ReadOnly="true" SortExpression="Faculty_ID" />
                            <asp:BoundField DataField="Faculty_Name" HeaderText="Faculty Name" ReadOnly="true" SortExpression="Faculty_Name" />
                      <asp:TemplateField>
                          <ItemTemplate>
                              <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%# Eval("Faculty_Code") %>'>Delete</asp:LinkButton>
                          </ItemTemplate>
                      </asp:TemplateField>
                  </Columns>
             ...
             <asp:SqlDataSource runat="server" ID="grdviewDatasource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Faculty_Profile]"></asp:SqlDataSource>
