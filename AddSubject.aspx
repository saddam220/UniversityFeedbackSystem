<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSubject.aspx.cs" Inherits="Practice.AddSubject" %>
...
<body>
  ...
  <asp:TextBox runat="server" ID="txtSubject" cssclass="form-control" placeholder="Enter Subject Name"  ></asp:TextBox>
  <div class="input-group-append">
    <asp:Button runat="server" ID="btnSubject" cssclass="btn btn-outline-secondary" text="Submit" OnClick="btnSubject_Click" />
  </div>
</div>
      <asp:Label runat="server" ID="lblmsg"></asp:Label>
              ...
              <asp:GridView runat="server" ID="grdview" DataSourceID="grdviewDatasource" CssClass="table table-hover list-group-item" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdview_RowCommand" >
                  <Columns>
                      ...
                      <asp:TemplateField>
                          <ItemTemplate>
                              <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%# Eval("Subject_ID") %>'>Delete</asp:LinkButton>
                          </ItemTemplate>
                      </asp:TemplateField>
                  </Columns>

              </asp:GridView>  
               <asp:SqlDataSource runat="server" ID="grdviewDatasource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Subject_Profile]"></asp:SqlDataSource>
