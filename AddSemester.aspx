<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSemester.aspx.cs" Inherits="Practice.AddSemester" %>
...
<body>
  ...
  <asp:TextBox runat="server" ID="txtSemester" cssclass="form-control" placeholder="Enter Semester Name"  ></asp:TextBox>
  <div class="input-group-append">
    <asp:Button runat="server" ID="btnSemester" cssclass="btn btn-outline-secondary" text="Submit" OnClick="btnSemester_Click" />
  </div>
</div>
      <asp:Label runat="server" ID="lblmsg" Text=""></asp:Label>
                ...
                <asp:GridView runat="server" ID="grdview" DataSourceID="grdviewDatasource" CssClass="table table-hover list-group-item" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdview_RowCommand">
                  <Columns>
                            <asp:BoundField DataField="Semester_Code" HeaderText="Semester ID" ReadOnly="true" SortExpression="Semester_Code" />
                            <asp:BoundField DataField="Semester_Name" HeaderText="Semester Name" ReadOnly="true" SortExpression="Semester_Name" />
                      <asp:TemplateField>
                          <ItemTemplate>
                              <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%# Eval("Semester_Code") %>'>Delete</asp:LinkButton>
                          </ItemTemplate>
                      </asp:TemplateField>
                  </Columns>
             ...
             <asp:SqlDataSource runat="server" ID="grdviewDatasource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Semester_Profile]"></asp:SqlDataSource>
