<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTeacher.aspx.cs" Inherits="Practice.AddTeacher" %>
...
<body>
  ...
  <asp:TextBox runat="server" ID="txtTeacher" CssClass ="form-control" placeholder="Enter Teacher Name"></asp:TextBox>
         
         
  <div class="input-group-append">
      
      <asp:Button runat="server" ID="btnTeacher"  cssclass="btn btn-outline-secondary" text="Submit" OnClick="btnTeacher_Click" />
      ...
      <asp:Label runat="server" ID="lblmsg" Text=""></asp:Label>
              ...
              <asp:GridView runat="server" ID="grdview" DataSourceID="grdviewDatasource" CssClass="table table-hover list-group-item" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdview_RowCommand" >
                  <Columns>
                            ...
                            <asp:BoundField DataField="Teacher_Name" HeaderText="Teacher Name" ReadOnly="true" SortExpression="Teacher_Name" />
                      <asp:TemplateField>
                          <ItemTemplate>
                              <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%# Eval("Teacher_ID") %>'>Delete</asp:LinkButton>
                          </ItemTemplate>
                      </asp:TemplateField>
                  </Columns>
             ...
             <asp:SqlDataSource runat="server" ID="grdviewDatasource" ConnectionString='<%$ ConnectionStrings:FeedbackSystemConnectionString %>' SelectCommand="SELECT * FROM [Teacher_Profile]"></asp:SqlDataSource>
